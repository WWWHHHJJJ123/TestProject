...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value = "AppPersonEntity对象", description = "个人信息表，主要是为了与应用权限以及用户组分清，不然可以直接调用mdm项目获取数据")
public class AppPersonEntity implements Serializable {
